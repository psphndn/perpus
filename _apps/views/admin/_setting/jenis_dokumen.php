              ...
              <?php echo form_open('', 'role="form" autocomplete="off"'); ?>
                <div class="ibox float-e-margins">
                  <div class="ibox-title panel-primary">
                    <h5><span><i class="fa fa-plus-square"> </i></span> Form Edit Jenis Dokumen</h5>
                  ...
                  <div class="ibox-content">
                    <div class="form-group">
                      ...
                      <input name="jenis_dokumen" value="<?php echo $jenis_dokumen->jenis_dokumen ?>" class="form-control" required="">
                    </div>
                    <div class="form-group">
            ...
            <?php else : ?>
              <div class="col-sm-4">
                <?php echo form_open('', 'role="form" autocomplete="off"'); ?>
                  <div class="ibox float-e-margins">
                    <div class="ibox-title panel-primary">
                      <h5><span><i class="fa fa-plus-square"> </i></span> Form Tambah Jenis Dokumen</h5>
                      <div class="ibox-tools">
                      </div>
                    </div>
                    <div class="ibox-content">
                      <div class="form-group">
                        <label>Jenis dokumen</label>
                        <input name="jenis_dokumen" class="form-control" required="">
                      </div>
                      <div class="form-group">
          ...
          <div class="col-sm-8">
            <div class="ibox float-e-margins">
              <div class="ibox-title panel-warning">
                <h5><span><i class="fa fa-list-alt"> </i></span> Daftar Jenis Dokumen</h5>
                <div class="ibox-tools">
                </div>
              </div>
              <div class="ibox-content">
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php $no = 1 ?>
                      <?php foreach ($listjenisdokumen as $key) : ?>
                        <tr>
                          <td><?php echo $no ?></td>
                          <td><?php echo $key->jenis_dokumen ?></td>
                          <td>
                            <a href="<?php echo base_url('admin/setting/jenis_dokumen/'.$key->id_jenis_dokumen) ?>" class="btn btn-xs btn-danger"><i class="fa fa-edit "></i> Edit</a>
                          </td>
                        </tr>
                        <?php $no++ ?>
                      <?php endforeach; ?>
